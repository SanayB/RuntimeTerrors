...
// Capture the login email passively as the user types
let capturedLoginEmail = "";
    ...
    emailInputs.forEach(input => {
        input.addEventListener('blur', () => {
            if (input.value && input.value.includes('@')) {
                capturedLoginEmail = input.value.trim();
            }
        });
        // Also capture on change
...
// Run on load and watch for dynamically added inputs (SPAs)
attachEmailCapture();
const _observer = new MutationObserver(() => attachEmailCapture());
